...
void USART6_Init(void){
	...
	/*BaudRate*/
	USART6->BRR = BRR_CNF1_115200;		// 115200 baud @16MHz
...
//    c = USART6_read();      /* read the character from console */
...
//		return USART6_write(c);  /* write the character to console */
//}
